...
`source.html?view=services|live|storage|tests|recovery`는 해당 캡처의 편집 가능한 정본이다. `03_actual_ingestion_e2e.png`는 발표 자료 5번 슬라이드의 렌더 결과다. PNG를 수정할 때는 1280×720으로 렌더링하고, 글자 잘림과 수치가 근거 문서와 일치하는지 확인한다.
...
| `03_actual_ingestion_e2e.png` | Historical 실제 거래 427건 발행, 174건이 final 1분봉 3건에 반영 | [실제 ingestion 보고서](../../test-results/2026-08-20-actual-ingestion.md) |
