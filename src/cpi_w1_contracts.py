...
class PromotionFamily(StrEnum):
    CPI_SCHEDULE_ASSERTION_PROMOTE = "CPI_SCHEDULE_ASSERTION_PROMOTE"
    ...
    CPI_CORRECTION_NOTICE_PROMOTE = "CPI_CORRECTION_NOTICE_PROMOTE"
    CPI_CORRECTION_OBSERVATION_PROMOTE = "CPI_CORRECTION_OBSERVATION_PROMOTE"
